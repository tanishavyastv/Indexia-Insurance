...
import { Highlight, HighlightItem } from "../unlumen-ui/primitives/effects/highlight";
...
function MotionNavigationMenuTrigger({
  ...
  return (
    <HighlightItem asChild>
      <button type="button" data-slot="navigation-menu-trigger" data-state={isOpen ? "open" : "closed"} aria-expanded={isOpen} className={cn(motionNavigationMenuTriggerStyle(), "group", className)} onPointerEnter={(event) => {
